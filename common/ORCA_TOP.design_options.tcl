...
if {[info exists synopsys_program_name]} {
	...
	if { $synopsys_program_name == "dc_shell" } {
		...
		create_placement_blockage -name pb_PCI -type allow_buffer_only -blocked_percentage 0 -boundary {{0.0000  0.0000} {0.0000  332.0000} \
               {202.0000 332.0000} {202.0000  77.0000} \
               {267.0000  77.0000} {267.0000  0.0000}}
		    create_placement_blockage -name pb_SDRAM -type allow_buffer_only -blocked_percentage 0 -boundary {{515.0000  0.0000} {515.0000 210.0000} \
                   {800.0000 210.0000} {800.0000  0.0000} }
		create_placement_blockage -name pb_CONTEXT -type allow_buffer_only -blocked_percentage 0 -boundary {{339.0000 385.0000} {339.0000 578.0000} \
                   {800.0000 578.0000} {800.0000 210.0000} \
                   {643.0000 210.0000} {643.0000 385.0000} }
		create_placement_blockage -name pb_RISC -type allow_buffer_only -blocked_percentage 0 -boundary {{0.0000  385.0000} {0.0000  578.0000} \
                   {300.0000 578.0000} {300.0000 385.0000} }
	...
	if [is_common_ui_mode ] { update_power_domain PD_RISC_CORE -box 524.9 10 889.9 207 
        } else { modifyPowerDomainAttr PD_RISC_CORE -box 524.9 10 889.9 207 }
	...
	if [is_common_ui_mode ] { set_db cts_target_max_transition_time 0.3ns
        ...
        if [is_common_ui_mode ] {
          edit_pin -edge 0 -pin [get_db $ports1 .name ] -layer M6 -spread_direction counterclockwise -spread_type start -offset_start 150 -spacing 1.216 -unit micron -fixed_pin 1 
          edit_pin -edge 0 -pin [get_db $ports2 .name ] -layer M8 -spread_direction counterclockwise -spread_type start -offset_start 150 -spacing 2.432 -unit micron -fixed_pin 1 
          set_db assign_pins_edit_in_batch false
        } else {
          editPin -edge 0 -pin [get_attribute $ports1 full_name ] -layer M6 -spreadDirection counterclockwise -spreadType START -offsetStart 150 -spacing 1.216 -unit MICRON -fixedPin 1 
          editPin -edge 0 -pin [get_attribute $ports2 full_name ] -layer M8 -spreadDirection counterclockwise -spreadType START -offsetStart 150 -spacing 2.432 -unit MICRON -fixedPin 1 
        }
