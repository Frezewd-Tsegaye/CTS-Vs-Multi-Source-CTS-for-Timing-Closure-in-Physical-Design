source -echo -verbose ../../common/$top_design.design_config.tcl
...
source -echo -verbose ../../common/${top_design}.design_options.tcl
...
if { $innovus_enable_manual_macro_placement == 0} {
    ...
    placeAIO -onlyAIO 
    source -echo -verbose ../../common/${top_design}.macro_placement_innovus.tcl
}
