...
echo create_rc_corner -name cmax -T -40 -cap_table ../../common/cadence_cap_tech/saed32nm_1p9m_Cmax.cap >> mmmc.tcl
echo create_rc_corner -name cmin -T -40 -cap_table ../../common/cadence_cap_tech/saed32nm_1p9m_Cmin.cap >> mmmc.tcl
#echo create_rc_corner -name default_rc_corner -T -40 -cap_table ../../common/cadence_cap_tech/saed32nm_1p9m_Cmax.cap >> mmmc.tcl
